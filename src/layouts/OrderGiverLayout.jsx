              ...
              <input
                ...
                onKeyDown={(e) => {
                  if (e.key === 'Enter') {
                    ...
                    if (q.length > 0) {
                      navigate(`/requests?q=${encodeURIComponent(q)}`);
                    }
                  }
                }}
              />
              ...
              {showUserMenu && (
                <div className="absolute right-0 mt-2 w-56 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                  ...
                  <ul className="py-1 text-sm text-gray-700">
                    <li>
                      <button className="w-full text-left px-4 py-2 hover:bg-gray-50" onClick={() => { setShowUserMenu(false); navigate('/settings'); }}>Settings</button>
                    </li>
                    <li>
...
export default OrderGiverLayout;