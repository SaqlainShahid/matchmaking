...
const Settings = () => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-2xl font-semibold mb-6" style={{ color: 'var(--text-dark)' }}>Settings</h1>
      ...
      <form onSubmit={handleSubmit}>
        <Card className="mb-6">
          <CardHeader>
            <CardTitle style={{ color: 'var(--text-dark)' }}>Profile</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="mb-6">
          <CardHeader>
            <CardTitle style={{ color: 'var(--text-dark)' }}>Dashboard Preferences</CardTitle>
          </CardHeader>
          <CardContent>
