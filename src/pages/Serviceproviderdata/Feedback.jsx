...
const FeedbackProvider = () => {
  ...
  const onSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      await submitFeedback({ subject, message, rating: Number(rating), role: 'service_provider' });
    ...
    <div className="space-y-6">
      <div className="card">
        <div className="card-content">
          ...
          <p className="text-gray-600 mt-1">Share your experience delivering services or platform suggestions.</p>
        </div>
      </div>
        ...
        <CardContent className="card-content">
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Input value={subject} onChange={(e) => setSubject(e.target.value)} placeholder="E.g., Request assignment process" />
            </div>
            <div>
