  ...
  return (
    <div className="space-y-6">
      ...
      <nav className="text-sm text-gray-600">
        <Link to="/admin/providers" className="text-green-700 hover:underline">Providers</Link>
        <span className="mx-2">/</span>
        <Link to={`/admin/providers/${providerId}/services`} className="text-green-700 hover:underline">Services</Link>
        <span className="mx-2">/</span>
        <span className="text-gray-900 font-medium">{service?.title || 'Service Detail'}</span>
      </nav>

      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-gray-900 tracking-tight">Service Detail</h2>
        <div className="flex gap-2">
          <Button variant="outline" onClick={() => navigate(-1)}>Back</Button>
          <Link to={`/admin/providers/${providerId}/services`} className="btn btn-outline">All Services</Link>
        </div>
      </div>
      ...
      <Card className="border border-gray-200 rounded-lg shadow-sm">
        ...
        <CardContent className="space-y-6">
          {loading ? (
            ...
            <div className="text-sm text-red-600">Service not found.</div>
          ) : (
            <>
              {/* Meta */}
